...
public class RegistroTransacoesBancarias {
    ...
    public static void main(String[] args) {
        ...
        // Itera sobre a lista de transações, retorna uma lista com as saídas esperadas e mostra na tela
        transacoes.stream().map(transacao -> index.incrementAndGet() + ". " + transacao).forEach(System.out::println);
